...
var fs = require('fs');
var _require = require('../../glslCanvsUniforms'), updateUniforms = _require.updateUniforms;
// updateUniforms({ statics: {} })
function Circle(_ref) {
    var _this = this;
    var x = _ref.x, y = _ref.y, r = _ref.r, vx = _ref.vx, vy = _ref.vy;
    this.x = x;
    this.y = y;
    this.r = r;
    this.vx = vx;
                ...
                switch (_context2.prev = _context2.next) {
                    ...
                    case 8:
                        ...
                        arr = circles.map(function (_ref6, i) {
                            var x = _ref6.x, y = _ref6.y, r = _ref6.r;
